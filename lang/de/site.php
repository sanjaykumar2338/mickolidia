...
return [
    ...
    'home' => [
        ...
        'hero_visual' => [
            ...
            'card_copy' => 'Die Homepage startet jetzt mit einer sauberen Trading-Visualisierung, damit die Marke eher wie ein serioeser Prop-Firm-Workspace als wie eine dekorative Promo-Karte wirkt.',
            'image_alt' => 'Laptop-aehnliche Trading-Oberflaeche mit Chart und Markt-Panels',
        ],
        'challenge_selector' => [
            ...
            'types' => [
                'one_step' => [
                    ...
                    'description' => 'Bestehe in einem Schritt. Werde schneller funded. Keine Verzoegerungen. Keine zweite Phase.',
                    'note_title' => '1-Step Instant Funded-Modell',
                    'note_body' => 'Strengere Regeln, engere Risikokontrolle und direkter Zugang zu einem Funded-Konto mit obligatorischer Konsistenz. Weniger Schritte. Hoehere Standards. Schnellere Ergebnisse.',
                ],
                'two_step' => [
                    'label' => '2-Step Pro',
                    'description' => 'Weniger Risiko. Mehr Skalierungspotenzial. Entwickelt fuer Konsistenz und langfristiges Wachstum.',
                    'note_title' => '2-Step Pro Funded-Modell',
                    'note_body' => 'Zwei-Phasen-Evaluation mit 1:100 Hebel in Phase 1, Auszahlungen alle 14 Tage und einem Skalierungssystem fuer profitable Funded-Konten. Baue Konsistenz auf. Skaliere aggressiv.',
                ],
            ],
        ],
        'plans' => [
            'eyebrow' => 'Challenge-Pläne',
            'title' => 'Lass dich funden und verdiene ab deiner allerersten Auszahlung Gewinne.',
            'description' => 'Waehle dein Modell, bestehe die Evaluation und erhalte Zugang zu realem Kapital mit klaren Regeln und schnellen Auszahlungen.',
    ...
    'launch_popup' => [
        ...
        'description' => 'Sichere dir dein Funded-Konto zum Launch-Preis, bevor das Angebot endet.',
        'secondary_copy' => 'Es gibt nur begrenzte Plaetze. Sobald sie vergeben sind, steigen die Preise.',
        'promo_label' => 'Promo-Code',
        'auto_apply_notice' => 'Dieser Launch-Code wird automatisch angewendet, sobald du fortfaehrst.',
        'copy_code' => 'Code kopieren',
        'code_copied' => 'Code kopiert',
        'primary_action' => 'Jetzt funded werden',
    ...
    'auth' => [
        ...
        'register' => [
            ...
            'copy' => 'Neu bei Wolforix? Erstelle zuerst dein Konto und schliesse danach Billing-Daten und Stripe-Checkout ab.',
    ...
    'checkout' => [
        ...
        'promo_code_help' => 'Gib den Launch-Code aus dem Start-Popup ein, um das 20-%-Angebot dieser Bestellung zuzuordnen. Der Launch-Preis ist im Betrag oben bereits enthalten.',
        'promo_code_applied' => 'Code aktiv',
        'promo_code_applied_copy' => 'Der Launch-Code wurde automatisch angewendet und das 20-%-Launch-Angebot ist bereits im Gesamtbetrag oben enthalten.',
    ...
    'contact' => [
        ...
        'voice_copy' => 'Stelle Wolfi eine Frage per Sprache oder Text. Antworten werden an Wolforix-FAQ, Regeln, Auszahlungen und Support-Hinweise angepasst.',
        ...
        'voice_intro_message' => 'Hallo, ich bin Wolfi. Ich helfe dir bei Plaenen, Auszahlungen, Regeln und allgemeinen Plattformfragen.',
