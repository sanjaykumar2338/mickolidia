...
return [
    ...
    'home' => [
        ...
        'badges' => [
            'EN / DE / ES bereit',
            'Kommunikation zur Konsistenzregel enthalten',
            'Stripe-Checkout für spätere Integration vorbereitet',
        ],
        'hero_panel' => [
            ...
            'items' => [
                '8 % Gewinnziel mit einer Evaluationsstruktur in 2 Schritten.',
                '5 % tägliches Verlustlimit direkt bei den Gewinnkennzahlen sichtbar.',
                '10 % Gesamtverlust-Grenze für spätere Regel-Logik vorbereitet.',
                'Zweiwöchentlicher Auszahlungsrhythmus und 3 Mindesthandelstage.',
            ],
        ],
        ...
        'plans' => [
            ...
            'title' => 'Planstruktur vorbereitet für Checkout, Auszahlungsregeln und spätere Stripe-Integration.',
            'description' => 'Die Preisstruktur ist modular aufgebaut, sodass Live-Kaufablauf, Kontoerstellung und Zahlungsanbieter in späteren Meilensteinen sauber angebunden werden können.',
            'badge' => 'Challenge- / Plan-Platzhalter',
        ...
        'foundation' => [
            ...
            'cards' => [
                ...
                [
                    ...
                    'description' => 'Konsistenzregel, zweiwöchentlicher Auszahlungszyklus, progressive Auszahlungshinweise und Prüfanforderungen sind bereits auf Website und im Dashboard sichtbar.',
                ],
                [
    ...
    'checkout' => [
        ...
        'helper_points' => [
            'Die Validierung ist aktiv für Namen, E-Mail, Planauswahl und die verpflichtende Einverständnis-Checkbox.',
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        ...
                        'answer' => 'Auszahlungen hängen vom Gesamtgewinn, der Einhaltung der Konsistenzregel und internen Auszahlungslimits ab. Der auszahlungsfähige Betrag kann niedriger sein als der Gesamtgewinn, wenn Tagesgrenzen überschritten wurden.',
                    ],
                    [
                        'question' => 'Warum könnte meine Auszahlung auf mehrere Zyklen aufgeteilt werden?',
                        'answer' => 'Zur langfristigen Nachhaltigkeit werden Auszahlungen progressiv verteilt. So kann das Unternehmen alle berechtigten Gewinne erfüllen, ohne die Mittel zu überdehnen.',
                    ],
                ],
            ],
            [
                ...
                'items' => [
                    ...
                    [
                        ...
                        'answer' => 'Die Schaltfläche zur Auszahlung befindet sich in Ihrem Dashboard. Nur Gewinne, die unter die Konsistenzregel und die Auszahlungslimits fallen, werden berücksichtigt.',
                    ],
                ],
            ],
            [
    ...
    'legal' => [
        ...
        'pages' => [
            ...
            'payout_policy' => [
                ...
                'sections' => [
                    ...
                    [
                        ...
                        'bullets' => [
                            'Die Mindestanzahl an Handelstagen muss erreicht sein.',
                            'Die Konsistenzregel muss erfüllt sein.',
                            'Es dürfen keine Regelverstöße auf dem Konto vorliegen.',
                        ],
                    ],
                    [
            ...
            'company_information' => [
                ...
                'intro' => 'Wolforix Ltd. ist ein im Vereinigten Königreich eingetragenes Unternehmen mit eingetragenem Sitz in London, Vereinigtes Königreich.',
                'sections' => [
                    [
                        'title' => 'Unternehmensinformationen',
                        'paragraphs' => [
                            'Wolforix Ltd. ist ein im Vereinigten Königreich eingetragenes Unternehmen mit eingetragenem Sitz in London, Vereinigtes Königreich.',
                        ],
                    ],
                    [
                        'title' => 'Art der Dienstleistungen',
    ...
    'footer' => [
        ...
        'company_location' => 'Wolforix Ltd. | London, Vereinigtes Königreich',
    ...
    'dashboard' => [
        ...
        'payouts' => [
            ...
            'requirements' => [
                'Die Mindestanzahl an Handelstagen muss erreicht sein.',
                'Die Konsistenzregel muss erfüllt sein, bevor Gewinn auszahlungsfähig wird.',
                'Es dürfen keine Regelverstöße auf dem Konto vorliegen.',
                'Alle Auszahlungsanfragen bleiben einer internen Handelsprüfung unterworfen.',
            ],
