...
return [
    ...
    'auth' => [
        ...
        'login' => [
            ...
            'social_unavailable_badge' => 'Bald',
            'social_setup_notice' => 'Die Social-Login-Oberfläche ist bereit, aber Provider-Zugangsdaten und Callback-Routen für Google, Facebook und Apple benötigen noch ein Backend-Setup.',
        ],
        'register' => [
