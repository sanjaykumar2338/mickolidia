...
return [
    ...
    'ai_assistant' => [
        ...
        'title' => 'Sprich mit deinem AI-Assistenten',
        'description' => 'Erhalte in Sekunden sofortige Antworten, Plattform-Hilfe und Trading-Support.',
        'multi_language' => 'Automatisch sprachbewusster Support',
        ...
        'preview_label' => 'Assistent-Vorschau',
        'preview_title' => 'Fragen vor dem Kauf stellen',
        'preview_badge' => '24/7',
        'preview_copy' => 'Öffne den Assistenten für schnelle Klarheit zu Regeln, News-Trading, Drawdown-Limits, Auszahlungszeiten und dem passenden Challenge-Modell.',
        'features' => [
            '24/7 Sofort-Support',
            'Mehrsprachige Unterstützung',
            'Sofortige Erklärung der Challenge-Regeln',
            'Trading- und Risiko-Hinweise',
            'Personalisierte Unterstützung',
        ],
        'example_questions' => [
            'Kann ich während News traden?',
            'Was passiert, wenn ich den maximalen Drawdown erreiche?',
            'Welcher Plan passt am besten zu mir?',
        ],
    ],
    ...
    'contact' => [
        ...
        'description' => 'Kontaktiere das Support-Team per E-Mail, starte einen E-Mail-gestuetzten Live-Chat oder nutze den FAQ-Sprachassistenten fuer schnelle Antworten vor oder nach dem Start deiner Challenge.',
        'primary_action' => 'Support mailen',
        'secondary_action' => 'FAQ oeffnen',
        'email_title' => 'E-Mail-Support',
        'email_copy' => 'Sende Fragen zu Billing, Konto oder Regeln direkt an das Wolforix-Support-Team.',
        'email_response' => 'Typische Antworten kommen waehrend der Supportzeiten: :hours.',
        ...
        'live_chat_note' => 'Antworten koennen ausserhalb der Geschaeftszeiten laenger dauern.',
        'live_chat_label' => 'Wobei brauchst du Hilfe?',
        'live_chat_placeholder' => 'Schreibe deine Frage, und wir bereiten sie fuer das Support-Postfach vor...',
        'live_chat_status' => 'Deine Live-Chat-Nachricht wird im Support-E-Mail-Composer geoeffnet.',
        ...
        'voice_copy' => 'Stelle Wolfi eine Frage per Sprache oder Text. Die Antworten greifen auf Wolforix-FAQ, Regeln, Auszahlungen, Rabattablauf und Support-Hinweise zurück.',
        'voice_ready' => 'Wolfi ist bereit.',
        'voice_listening' => 'Ich hoere zu... tippe erneut zum Stoppen.',
        'voice_unsupported' => 'Spracheingabe wird in diesem Browser nicht unterstuetzt. Du kannst deine Frage trotzdem eintippen.',
        'voice_no_match' => 'Keine passende FAQ-Antwort gefunden. Versuche eine klarere Frage oder oeffne die komplette FAQ.',
        'voice_intro_title' => 'Wolfi ist da.',
        'voice_intro_message' => 'Hallo, ich bin Wolfi. Ich helfe dir bei Plänen, Auszahlungen, Regeln, Rabatten und allgemeinen Fragen zur Plattform.',
        ...
        'voice_general_fallback' => 'Ich bin vor allem für Wolforix-Pläne, Demo-Zugang, Auszahlungen, Regeln, Login, Checkout und cTrader-Hinweise da. Wenn deine Frage breiter ist, helfe ich kurz so gut ich kann oder verweise dich auf die passende Wolforix-Seite.',
