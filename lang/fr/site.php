...
return array_replace_recursive($en, [
                ...
                'items' => [
                    [
                        ...
                        'answer_paragraphs' => [
                            ...
                            'Étape 3 : Une fois le compte démo créé, revenez sur Wolforix, saisissez votre numéro de compte MT5 et cliquez sur « J’ai déjà mon compte démo ».',
                            'Étape 4 : Après confirmation, vous aurez un accès complet à votre dashboard et pourrez commencer votre essai.',
    ...
    'trial' => [
        ...
        'setup' => [
            ...
            'description' => 'Ouvrez votre compte démo MT5 IC Markets, puis confirmez ici le numéro de compte pour débloquer votre dashboard d’essai Wolforix.',
            ...
            'steps' => [
                ...
                [
                    'title' => 'Étape 3 : Confirmer votre compte démo',
                    'body' => 'Revenez sur Wolforix et saisissez votre numéro de compte MT5 une fois le compte démo créé.',
                ],
                [
                    'title' => 'Étape 4 : Accéder à votre dashboard',
                    'body' => 'Après confirmation, vous aurez un accès complet à votre dashboard et pourrez commencer votre essai.',
                ],
            ],
            ...
            'confirm_title' => 'Confirmer votre compte démo',
            'confirm_copy' => 'Une fois votre compte démo créé, revenez ici et confirmez-le avec votre numéro de compte MT5.',
            'mt5_account_number_label' => 'Saisissez votre numéro de compte MT5 pour continuer.',
            'mt5_account_number_placeholder' => 'Exemple : 12345678',
            'confirm_button' => 'J’ai déjà mon compte démo',
            'confirm_success' => 'Votre compte démo a été confirmé. Votre dashboard d’essai est maintenant débloqué.',
