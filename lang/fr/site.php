...
return array_replace_recursive($en, [
    ...
    'contact' => [
        ...
        'voice_copy' => 'Posez une question à Wolfi par voix ou par texte. Les réponses s’appuient sur la FAQ Wolforix, les règles, les payouts, le flux de remise et l’aide support.',
        ...
        'voice_general_fallback' => 'Je suis surtout là pour les plans Wolforix, l’accès démo, les payouts, les règles, la connexion, le checkout et l’orientation cTrader. Si votre question est plus large, je peux quand même aider brièvement ou vous rediriger vers la bonne page Wolforix.',
