...
return array_replace_recursive($en, [
        ...
        'sections' => [
                    ...
                    [
                        ...
                        'answer_sections' => [
                            ...
                            [
                                ...
                                'bullets' => [
                                    '1. Ouvrez MT5.',
                                    '2. Fichier -> Connexion au compte de trading.',
                                    '3. Entrez vos informations de connexion.',
                                    '4. Serveur : MetaQuotes-Demo.',
                                ],
                            ],
                            [
                                'title' => 'À retenir',
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        ...
                        'answer_sections' => [
                            [
                                'title' => 'Observation du marché MT5',
                                'bullets' => [
                                    '1. Ouvrez MT5.',
                ...
                'items' => [
                    ...
                    [
                        ...
                        'answer_sections' => [
                            ...
                            [
                                'title' => 'Restrictions applicables',
                                'bullets' => [
            ...
            [
                ...
                'items' => [
                    [
                        ...
                        'answer_paragraphs' => [
                            'Les commissions sont payées sur demande et sont soumises à l’examen et à l’approbation de la Wolforix Partner Success Team. Le premier payout devient éligible après 21 jours, puis les payouts suivants sont disponibles selon des cycles récurrents de 14 jours.',
                            'Une fois la période de cycle requise terminée, les payouts sont traités sous 24 heures.',
                            'Pour demander un payout, envoyez un email à support@wolforix.com une fois le seuil minimum de retrait de $100 atteint.',
                        ],
                    ],
                    [
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        'question' => 'J’ai réussi, que dois-je faire maintenant ?',
                        'answer_paragraphs' => [
                            'La suite dépend du programme auquel vous participez, Wolforix Step-1 Instant ou Wolforix Step-Pro, car chaque programme suit une structure légèrement différente. Cependant, les deux incluent une phase de vérification.',
                        ],
                        'answer_sections' => [
                            [
                                'title' => 'Wolforix Step-1 Instant',
                                'paragraphs' => [
                                    'Après avoir atteint tous les objectifs de trading de votre compte Step-1 Instant, vous recevrez une notification dans votre dashboard confirmant que les objectifs ont été remplis et que votre compte est en cours d’examen.',
                                    'Le processus d’examen prend généralement 1 à 2 jours ouvrables. Une fois vos résultats vérifiés, vous recevrez l’accès à la phase de vérification.',
                                ],
                            ],
                            [
                                'title' => 'Phase de vérification',
                                'paragraphs' => [
                                    'Après avoir atteint tous les objectifs de trading de la phase de vérification, votre compte sera à nouveau examiné.',
                                    'Une fois vos résultats vérifiés, les étapes suivantes sont requises :',
                                ],
                                'bullets' => [
                                    'Compléter votre vérification d’identité (KYC/KYB) dans votre espace client',
                                    'Signer l’accord de compte Wolforix',
                                    'Une fois toutes les étapes terminées avec succès, votre compte Wolforix funded sera émis.',
                                ],
                            ],
                            [
                                ...
                                'paragraphs' => [
                                    'Première phase',
                                    'Après avoir atteint tous les objectifs de trading de la Phase 1, vous recevrez une notification confirmant votre réussite. À ce stade, aucun trading supplémentaire n’est requis et votre compte sera examiné.',
                                    'Le processus d’examen prend généralement 1 à 2 jours ouvrables. Une fois vérifié, vous recevrez l’accès à la phase suivante.',
                                ],
                            ],
                            [
                                'title' => 'Phase de vérification',
                                'paragraphs' => [
                                    'Après avoir atteint tous les objectifs de trading de la phase de vérification, votre compte passera en examen final.',
                                    'Une fois vos résultats vérifiés, les étapes suivantes sont requises :',
                                ],
                                'bullets' => [
                                    'Compléter votre vérification d’identité (KYC/KYB) dans votre espace client',
            ...
            [
                ...
                'items' => [
                    [
                        ...
                        'answer_paragraphs' => [
                            'Étape 1 : Créez votre compte gratuit Wolforix avec votre email et votre mot de passe.',
                            'Étape 2 : Ouvrez votre compte démo MT5 avec IC Markets depuis le bouton de l’écran de configuration du trial. Vous serez redirigé vers https://www.icmarkets.eu/de/open-trading-account/demo.',
                            'Important : utilisez le même email que celui utilisé sur Wolforix, sélectionnez MT5 comme plateforme et conservez vos identifiants de connexion.',
                            'Étape 3 : Téléchargez le connecteur MT5 Wolforix depuis votre dashboard d’essai et installez le EA dans MetaTrader 5.',
                            'Étape 4 : Faites glisser le connecteur sur un graphique, saisissez la Base URL, l’Account Reference et le Secret Token du dashboard, puis cliquez sur OK.',
                            'Étape 5 : Votre compte se connecte automatiquement lorsque le EA envoie sa première mise à jour.',
                            'Si vous rencontrez un problème lors de la création de votre compte démo, contactez support@wolforix.com.',
                        ],
                    ],
                ],
            ],
            [
                'title' => 'Support / Nous contacter',
                'items' => [
                    [
    ...
    'contact' => [
        ...
        'voice_trial_fallback' => 'Inscrivez-vous d’abord au Free Trial sur Wolforix et créez votre compte démo MT5 IC Markets. Téléchargez le connecteur MT5 Wolforix depuis le dashboard, installez l’EA dans MetaTrader 5, puis saisissez la Base URL, l’Account Reference et le Secret Token dans la fenêtre de paramètres de l’EA. La connexion se fait dans MT5; il n’y a pas de champ de numéro MT5 sur le site.',
    ...
    'trial' => [
        ...
        'setup' => [
            'title' => 'Configurer votre compte d’essai',
            'description' => 'Ouvrez votre compte démo MT5 IC Markets, installez le connecteur MT5 Wolforix et saisissez les informations du connecteur dans MetaTrader 5.',
            'process_label' => 'Processus du trial',
            'steps' => [
                [
                    'title' => 'Étape 1 : Créer votre compte gratuit',
                    'body' => 'Inscrivez-vous avec votre email et votre mot de passe pour démarrer votre essai gratuit.',
                ],
                [
                    'title' => 'Étape 2 : Ouvrir votre compte démo',
                    'body' => 'Ouvrez votre compte démo MT5 avec IC Markets. Vous serez redirigé vers leur site web.',
                ],
                [
                    'title' => 'Étape 3 : Installer le connecteur MT5',
                    'body' => 'Téléchargez le connecteur MT5 Wolforix et faites glisser l’Expert Advisor sur un graphique dans MetaTrader 5.',
                ],
                [
                    'title' => 'Étape 4 : Saisir les informations du connecteur',
                    'body' => 'Collez la Base URL, l’Account Reference et le Secret Token du dashboard dans les champs du EA. Le dashboard se met à jour automatiquement après le premier sync.',
                ],
            ],
            'step_two_label' => 'Étape 2',
            'open_demo_title' => 'Ouvrir votre compte démo',
            'open_demo_copy' => 'Cliquez sur le bouton ci-dessous pour ouvrir votre compte démo MT5 avec IC Markets. Vous serez redirigé vers leur site web.',
            'important_items' => [
                'Utilisez le même email que celui utilisé pour vous inscrire.',
                'Sélectionnez MT5 comme plateforme.',
                'Conservez vos identifiants de connexion.',
            ],
            'open_demo_button' => 'Ouvrir un compte démo',
            'step_three_label' => 'Étape 3',
            'continue_button' => 'Aller au dashboard d’essai',
            'continue_success' => 'Vos informations de connecteur sont prêtes. Installez le EA dans MT5 et votre dashboard se mettra à jour automatiquement après le premier sync.',
            'help_title' => 'Besoin d’aide ?',
            'help_copy' => 'Si vous rencontrez un problème lors de la création de votre compte démo, contactez notre équipe support à',
        ],
        'dashboard' => [
    ...
    'auth' => [
        ...
        'passwords' => [
            ...
            'status' => [
                ...
                'mailer' => 'Nous ne pouvons pas envoyer l’email de réinitialisation pour le moment. Contactez le support ou réessayez plus tard.',
            ],
        ],
    ],
    'dashboard' => [
