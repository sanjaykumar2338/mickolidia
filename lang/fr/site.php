...
return array_replace_recursive($en, [
    ...
    'contact' => [
        ...
        'voice_trial_fallback' => 'Inscrivez-vous d’abord au compte Trial sur Wolforix. Wolforix envoie un email d’instructions, vous complétez l’inscription démo IC Markets, IC Markets envoie vos identifiants démo, puis vous pouvez commencer l’essai gratuit.',
