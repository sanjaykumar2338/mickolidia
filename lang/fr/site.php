...
return array_replace_recursive($en, [
    ...
    'ai_assistant' => [
        ...
        'description' => 'Laissez Wolfi vous guider dans les règles, les payouts, l’accès MT5 et la prochaine étape sur la plateforme.',
    ...
    'contact' => [
        ...
        'voice_copy' => 'Posez une question à Wolfi par voix ou par texte. Wolfi vous guide dans Wolforix avec la FAQ, les règles, les payouts, les remises, l’accès MT5 et le support.',
    ...
    'dashboard' => [
        ...
        'wolfi' => [
            'entry_eyebrow' => 'Support Wolfi',
            'entry_title' => 'Besoin de contexte ? Ouvrez Wolfi Hub.',
            'entry_copy' => 'Wolfi peut expliquer votre compte sélectionné, les règles, la préparation payout et l’espace actuel sans masquer la vue trading.',
            ...
            'assistant' => [
                'eyebrow' => 'Assistant support de compte',
                'title' => 'Wolfi soutient votre espace de trading',
                'description' => 'Utilisez Wolfi Hub pour une aide contextualisée sur la synchro MT5, les règles, les payouts, les métriques et le support sans remplacer le dashboard.',
                'sources_title' => 'Ancré dans les données Wolforix',
                'sources_copy' => 'Wolfi répond depuis la structure du dashboard, les règles, la logique payout, le contexte de compte et le support.',
            ...
            'pillars' => [
                ['title' => 'Guide plateforme', 'description' => 'Aide pas à pas pour aperçu, comptes, payouts, Wolfi Hub et réglages.'],
                ['title' => 'Règles challenge', 'description' => 'Explique drawdown, jours de trading, consistance et logique de réussite ou d’échec.'],
                ['title' => 'Insights performance', 'description' => 'Traduit solde, equity, P&L flottant, drawdown et préparation payout.'],
                ['title' => 'Assistant support', 'description' => 'Traite les questions opérationnelles et dirige vers le bon flux Wolforix.'],
            ],
            'quick_actions' => [
