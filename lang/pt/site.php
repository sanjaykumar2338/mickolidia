...
return array_replace_recursive($en, [
    ...
    'ai_assistant' => [
        ...
        'title' => 'Fale com Wolfi',
        'description' => 'Deixe o Wolfi guiá-lo por regras, payouts, acesso MT5 e o próximo passo certo na plataforma.',
        'multi_language' => 'Fala a sua língua instantaneamente',
        'start_chat' => 'Experimente o Wolfi agora',
    ...
    'home' => [
        ...
        'trust' => [
            ...
            'title' => 'Posicionamento de segurança visível desde a primeira visita.',
            'description' => 'A Wolforix está a construir confiança operacional em torno de infraestrutura segura, controlos de risco, monitorização e alinhamento ISO/IEC 27001 atualmente em curso.',
            'cta' => 'Ver segurança',
            'items' => [
                [
                    'title' => 'Infraestrutura segura',
                    'description' => 'Alojamento protegido e acesso operacional controlado aos sistemas principais.',
                ],
                [
                    'title' => 'Controlo de risco avançado',
                    'description' => 'Controlos preventivos e percursos de revisão concebidos para reduzir o risco operacional.',
                ],
                [
                    'title' => 'Monitorização em tempo real',
                    'description' => 'Visibilidade contínua sobre a atividade da plataforma, eventos e estado dos serviços.',
                ],
                [
                    'title' => 'Alinhamento ISO/IEC 27001',
                    'description' => 'Roadmap de alinhamento em curso sem qualquer alegação de certificação.',
                ],
            ],
            'support_items' => [
    ...
    'trial' => [
        ...
        'register' => [
            ...
            'markets_line' => 'Mercados disponíveis: :markets',
        ...
        'dashboard' => [
            ...
            'markets_title' => 'Mercados disponíveis',
                ...
                'items' => [
                    ...
                    [
                        ...
                        'answer_paragraphs' => [
                            ...
                            'Isto inclui, entre outros, Irão, Coreia do Norte, Síria, Sudão, Cuba, Rússia e Venezuela.',
                        ],
                        'answer_sections' => [
                            [
                                'title' => 'Elegibilidade',
    ...
    'contact' => [
        ...
        'voice_copy' => 'Pergunte ao Wolfi por voz ou texto. O Wolfi guia-o pela Wolforix usando FAQ, regras da challenge, payouts, descontos, acesso MT5 e suporte.',
        ...
        'voice_intro_title' => 'O Wolfi está aqui.',
        'voice_intro_message' => 'Olá, sou o Wolfi. Posso ajudar com planos, payouts, regras, descontos e questões gerais da plataforma.',
    ...
    'dashboard' => [
        ...
        'wolfi' => [
            'entry_eyebrow' => 'Suporte Wolfi',
            'entry_title' => 'Precisa de contexto? Abra o Wolfi Hub.',
            'entry_copy' => 'O Wolfi pode explicar a conta selecionada, regras, readiness de payout e workspace atual sem tapar a vista de trading.',
            ...
            'assistant' => [
                'eyebrow' => 'Assistente de suporte da conta',
                'title' => 'Wolfi apoia o seu workspace de trading',
                'description' => 'Use o Wolfi Hub para orientação com contexto de conta sobre sincronização MT5, regras, payouts, métricas e suporte sem substituir o dashboard.',
                'sources_title' => 'Baseado em dados Wolforix',
                'sources_copy' => 'O Wolfi responde a partir da estrutura do dashboard, regras, lógica de payout, contexto da conta e suporte.',
            ...
            'pillars' => [
                ['title' => 'Guia da plataforma', 'description' => 'Ajuda passo a passo para overview, contas, payouts, Wolfi Hub e definições.'],
                ['title' => 'Regras da challenge', 'description' => 'Explica drawdown, dias de trading, consistência e lógica de aprovação ou falha.'],
                ['title' => 'Insights de performance', 'description' => 'Traduz balance, equity, P&L flutuante, drawdown e readiness de payout.'],
                ['title' => 'Assistente de suporte', 'description' => 'Responde a perguntas operacionais e aponta para o fluxo Wolforix certo.'],
            ],
            'quick_actions' => [
