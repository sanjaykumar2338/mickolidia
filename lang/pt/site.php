...
return array_replace_recursive($en, [
    ...
    'contact' => [
        ...
        'voice_trial_fallback' => 'Registe-se primeiro no Free Trial da Wolforix e crie a sua conta demo MT5 da IC Markets. Descarregue o conector MT5 da Wolforix no dashboard, instale o EA no MetaTrader 5 e introduza a Base URL, Account Reference e Secret Token na janela de definições do EA. A ligação acontece dentro do MT5; não existe campo para número MT5 no site.',
