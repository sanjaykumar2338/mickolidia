...
return [
    ...
    'home' => [
        ...
        'hero_visual' => [
            ...
            'card_copy' => 'La homepage ahora abre con una visual limpia de trading para que la marca se sienta mas como un workspace serio de prop firm que como una tarjeta promocional decorativa.',
            'image_alt' => 'Interfaz de trading estilo laptop con grafico y paneles de mercado',
        ],
        'challenge_selector' => [
            ...
            'entry_fee' => 'Precio de lanzamiento',
            'current_price' => 'Precio de lanzamiento',
            ...
            'types' => [
                ...
                'two_step' => [
                    ...
                    'note_body' => 'Evaluación en dos fases con apalancamiento 1:100 en la Fase 1, payouts cada 14 días y un sistema de escalado para cuentas funded rentables. Construye consistencia. Escala agresivamente.',
                ],
            ],
        ],
        'plans' => [
    ...
    'launch_popup' => [
        ...
        'description' => 'Asegura tu cuenta funded con precio de lanzamiento antes de que desaparezca.',
        'secondary_copy' => 'Las plazas son limitadas. Cuando se llenen, los precios subiran.',
        'promo_label' => 'Codigo promocional',
        'auto_apply_notice' => 'Este codigo de lanzamiento se aplica automaticamente cuando continúas.',
        'copy_code' => 'Copiar codigo',
        'code_copied' => 'Codigo copiado',
        'primary_action' => 'Consigue funding ahora',
    ...
    'auth' => [
        ...
        'login' => [
            ...
            'social_unavailable_badge' => 'Pronto',
            'social_setup_notice' => 'La interfaz de login social ya está lista, pero las credenciales y rutas callback de Google, Facebook y Apple todavía necesitan configuración backend.',
        ],
        'register' => [
            'title' => 'Crear cuenta',
    ...
    'checkout' => [
        ...
        'page_description' => 'Wolforix ahora crea primero un pedido real y luego inicia una sesion real de Stripe Checkout con precios calculados en el servidor. PayPal queda preparado para mas adelante.',
        ...
        'redirect_note' => 'La homepage ahora redirige directamente a una pagina de checkout dedicada, donde se gestionan de forma segura los datos de facturacion, el proveedor de pago y la creacion de la sesion de Stripe.',
        'promo_code_title' => 'Codigo promo de lanzamiento',
        'promo_code_label' => 'Codigo promocional',
        'promo_code_badge' => 'Acceso launch 20 %',
        'promo_code_help' => 'Introduce el codigo de lanzamiento del popup inicial para vincular la oferta del 20 % a este pedido. El precio launch ya esta reflejado en el importe superior.',
        'promo_code_applied' => 'Codigo aplicado',
        'promo_code_applied_copy' => 'El codigo de lanzamiento se aplico automaticamente y la oferta launch del 20 % ya esta reflejada en el total superior.',
        ...
        'buttons' => [
            'stripe' => 'El checkout con tarjeta de Stripe ya esta activo en este hito.',
            'paypal' => 'PayPal se agregara mas adelante usando la misma arquitectura de pedidos y pagos.',
        ],
        'providers' => [
            'stripe' => [
                'label' => 'Stripe',
            ...
            'paypal' => [
                'label' => 'PayPal',
                'description' => 'Preparado en la arquitectura y en la UI, pero todavia no conectado.',
            ],
        ],
        'success' => [
    ...
    'contact' => [
        ...
        'voice_copy' => 'Pregunta a Wolfi por voz o por texto. Las respuestas se ajustan a la FAQ de Wolforix, reglas, payouts y guía de soporte.',
        ...
        'voice_no_match' => 'No se encontro una respuesta cercana en la FAQ. Prueba una pregunta mas clara o abre la FAQ completa.',
        'voice_intro_title' => 'Wolfi está aquí.',
        'voice_intro_message' => 'Hola, soy Wolfi. Puedo ayudarte con planes, payouts, reglas y preguntas generales de la plataforma.',
