...
return [
    ...
    'ai_assistant' => [
        ...
        'floating_aria' => 'Open Wolfi, your AI assistant',
        'close_aria' => 'Close Wolfi',
        'preview_label' => 'Wolfi Preview',
        'preview_title' => 'Ask Wolfi before you buy',
        'preview_badge' => '24/7',
        ...
        'visual_title' => 'Always on. Always ready.',
        'visual_copy' => 'Use Wolfi as a visible guide for rules, payouts, MT5 access, and platform questions.',
        'visual_response_label' => 'Live response',
        'visual_response_preview' => 'Your max drawdown is 5% on this account.',
    ...
    'home' => [
        ...
        'trust' => [
            ...
            'support_items' => [
                'Data protection controls with limited access and controlled handling.',
                'Security roadmap and continuous-improvement work remain active.',
            ],
        ],
        'hero_visual' => [
            ...
            'card_copy' => 'The homepage now leads with a clean trading visual that feels closer to a real prop-firm workspace than a decorative promo card.',
            'image_alt' => 'Laptop-style trading interface with chart and market panels',
        ],
        'challenge_selector' => [
            ...
            'types' => [
                'one_step' => [
                    ...
                    'description' => 'Pass in one step. Get funded faster. No delays. No second phase.',
                    'note_title' => '1-Step Instant funded model',
                    'note_body' => 'Stricter rules, tighter risk control, and direct access to a funded account with mandatory consistency. Fewer steps. Higher standards. Faster results.',
                ],
                'two_step' => [
                    'label' => '2-Step Pro',
        ...
        'plans' => [
            ...
            'title' => 'Trade 1,000+ Instruments on MT5',
            'description' => 'All instruments available in your MT5 account are fully supported and automatically tracked.',
        ...
        'foundation' => [
            ...
            'cards' => [
                ...
                [
                    ...
                    'description' => 'English stays the default while the platform is structured so additional languages can be added cleanly without breaking the core experience.',
                ],
            ],
        ],
        'about' => [
    ...
    'news' => [
        'eyebrow' => 'Macro risk calendar',
        'title' => 'Economic News Calendar',
        'description' => 'Track upcoming macro and economic releases to manage exposure around volatility-sensitive trading sessions.',
        'warning_title' => 'Volatility notice',
        'warning_copy' => 'High-impact news can increase volatility and affect trading conditions. Monitor scheduled events as part of your risk management process.',
        'data_source_label' => 'Calendar source',
        'mode_demo' => 'Demo calendar mode',
        'mode_live' => 'Live calendar mode',
        'demo_notice' => 'The calendar is currently running in demo mode with realistic sample events until licensed API credentials are configured.',
        'live_notice' => 'The calendar is currently using the configured licensed API provider.',
        'timezone_badge' => ':timezone (:abbr) display',
        'range_caption' => 'Showing events from :from to :to',
        'filters' => [
            'impact' => 'Impact',
            'currency' => 'Currency',
            'range' => 'Date range',
            'high_only' => 'High impact only',
            'apply' => 'Apply filters',
            'reset' => 'Reset',
        ...
        'table' => [
            ...
            'forecast' => 'Forecast',
            'previous' => 'Previous',
            'empty' => 'No economic calendar events matched the selected filters.',
        ],
        'impact' => [
            'high' => 'High',
            'medium' => 'Medium',
    ...
    'auth' => [
        ...
        'login' => [
            ...
            'social_setup_notice' => 'Social sign-in appears automatically once the provider credentials are configured in the environment.',
            'social_unavailable_error' => 'This social sign-in provider is not configured yet.',
            'social_failed' => 'Social sign-in could not be completed. Please try again or use email login.',
            'social_cancelled' => 'Social sign-in was canceled before completion.',
            'social_state_invalid' => 'The social sign-in session expired. Please try again.',
        ],
        'register' => [
        ...
        'passwords' => [
            ...
            'status' => [
                ...
                'mailer' => 'We could not send the reset email right now. Please contact support or try again later.',
            ],
        ],
    ],
    ...
    'trial' => [
        ...
        'register' => [
            ...
            'existing_account_error' => 'This email already has a Wolforix account. Enter the correct password here to continue into Free Trial.',
        ],
        'setup' => [
            'title' => 'Set Up Your Trial Account',
            'description' => 'Open your IC Markets MT5 demo account, then confirm the account number here to unlock your Wolforix trial dashboard.',
            ...
            'steps' => [
                ...
                [
                    'title' => 'Step 3: Confirm Your Demo Account',
                    'body' => 'Return to Wolforix and enter your MT5 account number once the demo account has been created.',
                ],
                [
                    'title' => 'Step 4: Access Your Dashboard',
                    'body' => 'After confirmation, you will get full access to your dashboard and can start your trial.',
                ],
            ],
            'step_two_label' => 'Step 2',
            'open_demo_title' => 'Open Your Demo Account',
            'open_demo_copy' => 'Click the button below to open your MT5 demo account with IC Markets. You will be redirected to their website.',
            'important_items' => [
                'Use the same email you used to register.',
                'Select MT5 as your platform.',
                'Save your login details.',
            ],
            'open_demo_button' => 'Open Demo Account',
            'step_three_label' => 'Step 3',
            'confirm_title' => 'Confirm Your Demo Account',
            'confirm_copy' => 'Once you have created your demo account, return here and confirm it with your MT5 account number.',
            'mt5_account_number_label' => 'Enter your MT5 Account Number to continue.',
            'mt5_account_number_placeholder' => 'Example: 12345678',
            'confirm_button' => 'I already have my Demo Account',
            'confirm_success' => 'Your demo account has been confirmed. Your trial dashboard is now unlocked.',
            'help_title' => 'Need help?',
            'help_copy' => 'If you have any issues creating your demo account, contact our support team at',
        ],
        'dashboard' => [
    ...
    'checkout' => [
        ...
        'supporting_copy' => 'The selected challenge is converted into an internal order first, then the chosen provider handles payment externally. Order status, retries, and future gateway additions all use the same internal purchase flow.',
        'kyc_notice' => 'Billing details are stored with the order and prepared for future registration, compliance review, and payout-related account checks.',
        'helper_points' => [
            'Server-side pricing is the source of truth, so client-side amounts are never trusted during checkout.',
            'Orders remain available for retry if payment is canceled or fails.',
        ...
        'platform' => 'Platform',
        'platform_value' => 'MT5',
        'agreement' => 'Checkout requires acceptance of the Terms & Conditions, confirmation of your current country of residence, and acceptance of the Cancellation and Refund Policy.',
        'confirmation_title' => 'Required confirmations',
        'confirmations' => [
            'terms_and_residency_html' => 'I declare that I have read and agree with <a href=":terms_url" target="_blank" rel="noopener noreferrer" class="font-semibold text-white underline underline-offset-4">Terms & Conditions</a> and I declare that the country of residence stated in the above order is my current country of residence.',
            'refund_policy_html' => 'I declare that I have read and agree with the <a href=":refund_url" target="_blank" rel="noopener noreferrer" class="font-semibold text-white underline underline-offset-4">Cancellation and Refund Policy</a>.',
        ],
        ...
        'success' => [
            ...
            'title' => 'Challenge order confirmed',
            'description' => 'Your payment has been confirmed and the purchased challenge has been linked to your Wolforix order record.',
            'pending_description' => 'The checkout returned successfully. We are finalizing confirmation against the payment provider and will keep this order linked for completion.',
            'plan' => 'Purchased plan',
            'amount' => 'Amount paid',
        ...
        'cancel' => [
            ...
            'description' => 'The payment was canceled before completion. The order record remains available so you can retry without losing the selected challenge and billing details.',
            'order_number' => 'Order number',
            'plan' => 'Selected plan',
            'amount' => 'Amount due',
            'retry' => 'Retry Payment',
        ...
        'errors' => [
            'provider_unavailable' => 'The selected payment provider could not start a checkout session. Verify provider credentials and try again.',
        ],
        'validation' => [
    ...
    'faq' => [
        ...
        'sections' => [
            ...
            [
                ...
                'items' => [
                    [
                        'question' => 'What platform does Wolforix use?',
                        'answer' => 'Wolforix uses MetaTrader 5 (MT5).',
                    ],
                    [
                        'question' => 'How do I log in to MT5?',
                        'answer_sections' => [
                            [
                                'title' => 'Mobile',
                                'bullets' => [
                                    ...
                                    '3. Tap "+".',
                                    '4. Select "Log in to an existing account".',
                                    '5. Search: MetaQuotes-Demo.',
                            ...
                            [
                                ...
                                'bullets' => [
                                    '1. Open MT5.',
                                    '2. File -> Log in to Trade Account.',
                            ...
                            [
                                'title' => 'Important',
                                'bullets' => [
                                    'Wolforix does not use its own broker.',
                                    'We use the MetaQuotes-Demo server.',
                                    'Your account is linked to Wolforix.',
                                    'All activity is synced with your dashboard.',
                                ],
                            ],
                        ],
                    ],
            ...
            [
                ...
                'items' => [
                    [
                        ...
                        'answer' => 'Wolforix provides access to a wide range of CFD instruments available in MT5.',
                        'answer_sections' => [
                            [
                                'title' => 'Forex',
                                'bullets' => [
                                    'EURUSD, GBPUSD, USDJPY, USDCHF, USDCAD',
                                    'AUDUSD, NZDUSD, EURJPY, GBPJPY, EURGBP and more',
                                ],
                            ],
                            [
                                'title' => 'Indices',
                    ...
                    [
                        'question' => 'How can I see all instruments?',
                        'answer_sections' => [
                            [
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        'question' => 'What trading times are allowed?',
                        'answer' => 'Wolforix allows trading during standard market hours depending on the instrument traded.',
                        'answer_sections' => [
                            [
                                'title' => 'General Rule',
                                'bullets' => [
                                    'Trading is available 24 hours, 5 days a week (Monday to Friday) in line with global market sessions.',
                                    'Availability may vary depending on the instrument, including Forex, indices, crypto, and other CFDs.',
                                ],
                            ],
                            [
                                'title' => 'Position Holding',
                                'bullets' => [
                                    'Positions can be held intraday or overnight, unless otherwise restricted by specific account rules.',
                                    'Traders are responsible for managing exposure during low-liquidity periods.',
                                ],
                            ],
                            [
                                'title' => 'Market Closures',
                                'bullets' => [
                                    'Trading is not available during weekends.',
                                    'Certain instruments may have daily breaks or maintenance windows.',
                                    'On holidays, market hours may be reduced or modified.',
                                ],
                            ],
                            [
                                'title' => 'Important',
                                'bullets' => [
                                    'Traders must be aware of market session times and liquidity conditions.',
                                    'Wolforix is not responsible for losses caused by trading during illiquid or volatile periods.',
                                ],
                            ],
                            [
                                'title' => 'Restrictions',
                                'bullets' => [
                                    'Trading restrictions related to news events (±5 minutes) still apply.',
                                    'All other trading rules remain in effect regardless of time.',
                                ],
                            ],
                        ],
                    ],
                    [
                        'question' => 'Which trading strategies are allowed?',
                        'answer_paragraphs' => [
                    ...
                    [
                        'question' => 'Are hedging across accounts and copy trading allowed?',
                        'answer' => 'Hedging across multiple accounts and unauthorized copy trading are strictly prohibited in Wolforix.',
                        'answer_sections' => [
                            [
                                'title' => 'What is Hedging?',
                                'paragraphs' => [
                                    'Hedging refers to taking opposite positions on the same or correlated instruments across multiple accounts to artificially reduce risk.',
                                    'This behavior guarantees that one account profits regardless of market direction and is considered system manipulation, not genuine trading.',
                                ],
                            ],
                            [
                                'title' => 'What is Copy Trading?',
                                'paragraphs' => [
                                    'Copy trading refers to replicating trades between multiple accounts, whether manually, through software, signals, or third-party services.',
                                ],
                                'bullets' => [
                                    'Copying trades between your own accounts.',
                                    'Copying trades between different users.',
                                    'Using signal groups, bots, or automation to mirror trades.',
                                    'Coordinated trading designed to bypass rules.',
                                ],
                            ],
                            [
                                'title' => 'Examples of Prohibited Activity',
                                'bullets' => [
                                    'Opening long and short positions on the same instrument across different accounts.',
                                    'Hedging between accounts owned by the same user.',
                                    'Hedging between coordinated users.',
                                    'Hedging across different firms or platforms.',
                                    'Trading correlated instruments in opposite directions across accounts.',
                                    'Copying or mirroring trades between accounts, manually or automatically.',
                                    'Using trade copier software or signal services to replicate trades.',
                                ],
                            ],
                            [
                                'title' => 'Examples',
                                'bullets' => [
                                    'Long EURUSD in one account and short EURUSD in another.',
                                    'Long SPX500 in one account and short NDX100 in another.',
                                    'Executing identical trades across multiple accounts at the same time.',
                                    'Using a bot or signal provider to replicate trades across accounts.',
                                ],
                            ],
                            [
                                'title' => 'What is Allowed?',
                                'bullets' => [
                                    'Independent trading decisions per account.',
                                    'Use of personal strategies not shared across multiple accounts.',
                                    'Proper risk management within a single account.',
                                ],
                            ],
                            [
                                'title' => 'Important Clarification',
                                'bullets' => [
                                    'Opening opposite positions within the same account may be technically possible in MT5, but strategies designed to bypass risk rules are not allowed.',
                                    'Using automation is allowed only if it reflects independent trading logic, not trade replication.',
                                    'All trading must reflect real, independent decision-making and market exposure.',
                                ],
                            ],
                            [
                                'title' => 'Detection & Monitoring',
                                'bullets' => [
                                    'Wolforix uses internal systems to detect hedging patterns.',
                                    'Wolforix monitors trade synchronization.',
                                    'Wolforix monitors identical execution behavior across accounts.',
                                    'Wolforix monitors copy trading activity.',
                                ],
                            ],
                            [
                                'title' => 'Consequences',
                                'bullets' => [
                                    'Wolforix may remove or adjust trades.',
                                    'Wolforix may recalculate account balance.',
                                    'Wolforix may disqualify the account.',
                                    'Wolforix may restrict or permanently ban the user.',
                                ],
                            ],
                            [
                                'title' => 'Why is this Prohibited?',
                                'bullets' => [
                                    'Hedging and copy trading misrepresent actual trading skill.',
                                    'Hedging and copy trading eliminate real risk exposure.',
                                    'Hedging and copy trading undermine the evaluation process.',
                                    'Hedging and copy trading threaten platform integrity.',
                                ],
                            ],
                        ],
                    ],
                    [
                        'question' => 'Is high-frequency trading (HFT) allowed?',
                        'answer' => 'High-frequency trading (HFT) is strictly prohibited in Wolforix.',
                        'answer_sections' => [
                            [
                                'title' => 'What is High-Frequency Trading?',
                                'paragraphs' => [
                                    'High-frequency trading (HFT) refers to automated strategies that execute a large number of trades within extremely short timeframes, often measured in seconds or milliseconds.',
                                    'These strategies are typically designed to exploit small price inefficiencies using speed and high order volume.',
                                ],
                            ],
                            [
                                'title' => 'What is Considered HFT?',
                                'bullets' => [
                                    'Executing a high volume of trades in very short periods.',
                                    'Rapid order placement and cancellation.',
                                    'Excessive modifications of orders.',
                                    'Ultra-fast algorithmic execution patterns.',
                                    'Trading behavior that places abnormal load on the platform.',
                                ],
                            ],
                            [
                                'title' => 'Important Clarification',
                                'bullets' => [
                                    'Algorithmic trading and EAs are allowed.',
                                    'Strategies must operate within normal trading frequency and realistic execution behavior.',
                                    'Any system designed primarily for speed exploitation rather than market analysis is not allowed.',
                                ],
                            ],
                            [
                                'title' => 'Why is HFT Prohibited?',
                                'paragraphs' => [
                                    'Wolforix is designed to evaluate skill and consistency, not speed-based system exploitation.',
                                ],
                                'bullets' => [
                                    'HFT can degrade platform performance.',
                                    'HFT can create execution instability.',
                                    'HFT can affect pricing consistency.',
                                    'HFT can impact the trading environment for other users.',
                                ],
                            ],
                            [
                                'title' => 'Detection & Monitoring',
                                'bullets' => [
                                    'Wolforix monitors trade frequency.',
                                    'Wolforix monitors order volume.',
                                    'Wolforix monitors execution patterns.',
                                    'Wolforix monitors server load impact.',
                                ],
                            ],
                            [
                                'title' => 'Consequences',
                                'bullets' => [
                                    ...
                                    'Profits generated from HFT activity may be removed.',
                    ...
                    [
                        'question' => 'Are duration abuse, grid trading, and martingale strategies allowed?',
                        'answer' => 'Wolforix strictly prohibits trading strategies that exploit risk structures or create unrealistic performance profiles, including duration abuse, grid trading, and martingale systems.',
                        'answer_sections' => [
                            [
                                'title' => 'Duration Abuse',
                                'paragraphs' => [
                                    'Duration abuse refers to systematically opening and closing trades in a way that bypasses intended risk exposure or trading rules, without genuine market participation.',
                                    'All trades must reflect genuine market exposure and intent, not rule manipulation.',
                                ],
                                'bullets' => [
                                    'Repeatedly opening and closing trades around the minimum duration threshold, for example just above 60 seconds.',
                                    'Executing trades with no real market intent, only to satisfy rule requirements.',
                                    'Artificial trade timing designed to bypass restrictions.',
                                ],
                            ],
                            [
                                'title' => 'Grid Trading',
                                'paragraphs' => [
                                    'Grid trading involves placing multiple pending or active orders at fixed price intervals, often without clear stop-loss logic.',
                                ],
                                'bullets' => [
                                    'Grid systems without proper risk control are not allowed.',
                                    'High-density order stacking is not allowed.',
                                    'Strategies that rely on price oscillation without defined risk are not allowed.',
                                ],
                            ],
                            [
                                'title' => 'Martingale Strategies',
                                'paragraphs' => [
                                    'Martingale strategies involve increasing position size after losses in order to recover previous losses with a single winning trade.',
                                ],
                                'bullets' => [
                                    'Doubling or increasing lot sizes after losses is not allowed.',
                                    'Recovery-based position sizing without risk limits is not allowed.',
                                    'Strategies that create exponential risk exposure are not allowed.',
                                ],
                            ],
                            [
                                'title' => 'What is Allowed?',
                                'bullets' => [
                                    'Structured strategies with defined risk per trade.',
                                    'Logical position sizing.',
                                    'Consistent and controlled exposure.',
                                    'Use of stop-loss and proper risk management.',
                                ],
                            ],
                            [
                                'title' => 'Detection & Monitoring',
                                'bullets' => [
                                    'Wolforix monitors trade duration patterns.',
                                    'Wolforix monitors position sizing behavior.',
                                    'Wolforix monitors order distribution.',
                                    'Wolforix monitors risk escalation patterns.',
                                ],
                            ],
                            [
                                'title' => 'Consequences',
                                'bullets' => [
                                    'Wolforix may remove or adjust trades.',
                                    'Wolforix may recalculate account balance.',
                                    'Wolforix may restrict trading activity.',
                                    'Wolforix may suspend or terminate the account.',
                                ],
                            ],
                            [
                                'title' => 'Why is this Prohibited?',
                                'bullets' => [
                                    'These strategies distort real trading performance.',
                                    'These strategies eliminate proper risk exposure.',
                                    'These strategies create unstable equity curves.',
                                    'These strategies are not sustainable under real market conditions.',
                                ],
                            ],
                        ],
                    ],
            ...
            [
                ...
                'items' => [
                    [
                        ...
                        'answer_paragraphs' => [
                            'Commissions are paid upon request and are subject to review and approval by the Wolforix Partner Success Team. The first payout becomes eligible after 21 days, with subsequent payouts available in recurring 14-day cycles.',
                            'Once the required cycle period has been completed, payouts are processed within 24 hours.',
                            'To request a payout, please submit an email to support@wolforix.com once the minimum withdrawal threshold of $100 has been reached.',
                        ],
                    ],
                    [
                        'question' => 'What payout methods are available?',
                        'answer' => 'Wolforix supports secure and efficient payout methods for approved withdrawals.',
                        'answer_sections' => [
                            [
                            ...
                            [
                                'title' => 'Important',
                                'bullets' => [
                                    'Payout methods may vary depending on your location.',
                                    'All withdrawals are subject to account review and compliance checks.',
                                    'Processing times may vary based on provider and region.',
                                ],
                            ],
                            [
                                'title' => 'Processing Time',
                                'bullets' => [
                                    'Requests are typically reviewed within 1–3 business days.',
                                    'Once approved, funds are processed shortly after.',
                                ],
                            ],
                            [
                                'title' => 'Additional Notes',
                                'bullets' => [
                                    'The payout method must match the account holder’s identity.',
                                    'Wolforix reserves the right to request verification before processing withdrawals.',
                                    'Fees may vary depending on the selected payout method.',
                                ],
                            ],
                        ],
                    ],
                    ...
                    [
                        ...
                        'answer' => '2-Step funded accounts can scale by +25% capital every 3 months if profitable. 1-Step funded accounts do not currently include that scaling rule.',
                    ],
                    [
                        'question' => 'How does the account scaling plan work?',
                        'answer_paragraphs' => [
                            'Wolforix applies a dynamic scaling system to funded accounts based on trading performance.',
                            'As your account grows, your maximum allowed position size increases progressively, allowing greater market exposure as consistency is demonstrated.',
                        ],
                        'answer_sections' => [
                            [
                                'title' => 'How the scaling system works',
                                'bullets' => [
                                    'Scaling is based on your simulated profits.',
                                    'As profits increase, your trading capacity increases.',
                                    'If performance declines, limits may be adjusted accordingly.',
                                ],
                            ],
                            [
                                'title' => 'Update Frequency',
                                'bullets' => [
                                    'Scaling updates are applied at the end of each trading day.',
                                    'Changes are not applied in real time during the day.',
                                ],
                            ],
                            [
                                'title' => 'Scaling Structure',
                                'paragraphs' => [
                                    'The scaling model is designed to reward consistency, risk management, and sustainable performance.',
                                    'Your maximum exposure evolves as your account demonstrates stability over time.',
                                ],
                            ],
                            [
                                'title' => 'Important',
                                'bullets' => [
                                    'Scaling is not linear and may vary depending on account performance.',
                                    'Overexposure without sufficient performance may result in restrictions.',
                                    'The system prioritizes long-term consistency over short-term gains.',
                                ],
                            ],
                            [
                                'title' => 'Circumventing the Scaling System',
                                'paragraphs' => [
                                    'Any attempt to bypass or manipulate the scaling system is strictly prohibited.',
                                ],
                                'bullets' => [
                                    'Splitting trades to exceed limits.',
                                    'Using multiple entries to artificially increase exposure.',
                                    'Exploiting execution behavior or platform mechanics.',
                                ],
                            ],
                            [
                                'title' => 'Consequences',
                                'bullets' => [
                                    'Wolforix may adjust or remove trades.',
                                    'Wolforix may recalculate account balance.',
                                    'Wolforix may restrict trading conditions.',
                                    'Wolforix may suspend or terminate the account.',
                                ],
                            ],
                            [
                                'title' => 'Summary',
                                'bullets' => [
                                    'Performance increases, trading capacity increases.',
                                    'Performance declines, limits may adjust.',
                                    'Scaling updates daily.',
            ...
            [
                ...
                'items' => [
                    [
                        ...
                        'answer' => 'Wolforix accepts secure online payments through trusted providers. All payments are processed securely via Stripe and PayPal, ensuring fast and reliable transactions.',
                        'answer_sections' => [
                            [
                            ...
                            [
                                'title' => 'Important',
                                'bullets' => [
                                    'Payments are confirmed instantly after approval.',
                                    'All transactions are encrypted and securely processed.',
                                    'Availability of certain payment methods may vary depending on your location.',
                                ],
                            ],
                        ],
                    ],
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        ...
                        'answer' => 'The payout request button is in your dashboard. 1-Step funded accounts must satisfy the obligatory consistency rule before profit becomes payout-eligible.',
                    ],
                    [
                ...
                'items' => [
                    [
                        ...
                        'answer_paragraphs' => [
                            ...
                            'Step 3: Once the demo account is created, return to Wolforix, enter your MT5 account number, and click “I already have my Demo Account”.',
                            'Step 4: After confirmation, you will get full access to your dashboard and can start your trial.',
                    ...
                    [
                        ...
                        'answer_sections' => [
                            [
                                'title' => 'Eligibility',
                                'bullets' => [
                                    'By using Wolforix services, you confirm that you are not a resident of any restricted jurisdiction.',
                                    'You confirm that you are not subject to any applicable sanctions.',
                                    'You confirm that you are legally allowed to participate under the laws of your country.',
                                ],
                            ],
                            [
                                'title' => 'Compliance',
                                'paragraphs' => [
                                    'Wolforix complies with international regulations, including anti-money laundering (AML) and counter-terrorism financing (CTF) policies.',
                                    'Access to services may be restricted based on country of residence, nationality, payment provider limitations such as Stripe or PayPal, or internal risk assessment.',
                                ],
                            ],
                            [
                                'title' => 'Important Notice',
                                'bullets' => [
                                    'Wolforix reserves the right to restrict or deny access to any user at its sole discretion.',
                                    'Wolforix may request identity verification (KYC) at any time.',
                                    'Wolforix may update the list of restricted jurisdictions without prior notice.',
                                ],
                            ],
                        ],
                    ],
    ...
    'search' => [
        ...
        'description' => 'Search plans, policies, support pages, and FAQ answers.',
        'placeholder' => 'Search pages, FAQs, and policies...',
        'empty' => 'No matching content found.',
        'close' => 'Close search',
        'featured_title' => 'Popular destinations',
        'results_one' => 'result',
    ...
    'contact' => [
        'eyebrow' => 'Contact Wolforix',
        'title' => 'Support, live chat, and FAQ voice help in one place.',
        'description' => 'Reach the support team by email, start an email-backed live chat, or use the FAQ voice assistant to get quick answers before or after you start a challenge.',
        'primary_action' => 'Email support',
        'secondary_action' => 'Open FAQ',
        'email_title' => 'Email support',
        'email_copy' => 'Send billing, account, or rules questions directly to the Wolforix support desk.',
        'email_response' => 'Typical responses arrive during business hours at :hours.',
        'email_button' => 'Send email',
        'live_chat_title' => 'Live chat',
        'live_chat_copy' => 'Use the live chat launcher below. If the team is offline, your message is routed to the support email queue so nothing gets lost.',
        'live_chat_note' => 'Responses may take longer outside business hours.',
        'live_chat_label' => 'What do you need help with?',
        'live_chat_placeholder' => 'Type your question and we will prepare it for the support inbox...',
        'live_chat_status' => 'Your live-chat message will open in the support email composer.',
        'live_chat_empty' => 'Type a message before starting live chat.',
        'live_chat_button' => 'Start live chat',
        'live_chat_subject' => 'Live chat support request',
        'voice_title' => 'Talk with Wolfi',
        'voice_copy' => 'Your trading assistant is ready to help.',
        'voice_online' => 'Online',
        'voice_state_idle' => 'Tap to talk',
        'voice_state_listening' => 'Listening',
        'voice_state_speaking' => 'Wolfi is speaking',
        'voice_state_rendering' => 'Wolfi is thinking',
        ...
        'voice_no_match' => 'I am not fully confident I understood that. Try rephrasing it, or open the full FAQ.',
        'voice_intro_title' => 'Talk with Wolfi',
        'voice_intro_message' => 'Your trading assistant is ready to help.',
        'voice_intro_blocked' => 'Wolfi opened, but your browser blocked immediate audio playback. Tap Play answer to hear the reply.',
        'voice_clarify_title' => 'Let me make sure I answer the right thing.',
        'voice_clarify_intro' => 'I may be mixing up your question. Try one of these instead: :suggestions',
        ...
        'voice_trial_fallback' => 'Register for the Trial Account on Wolforix first. Wolforix sends an instruction email, you complete the IC Markets demo registration, IC Markets sends your demo credentials, and then you can start the free trial.',
        ...
        'voice_payout_fallback' => 'Commissions are paid upon request and are subject to review and approval by the Wolforix Partner Success Team. The first payout becomes eligible after :first_payout_days days, with subsequent payouts available in recurring :payout_cycle_days-day cycles. Once the required cycle period has been completed, payouts are processed within 24 hours. To request a payout, please submit an email to support@wolforix.com once the minimum withdrawal threshold of $100 has been reached.',
        ...
        'voice_general_fallback' => 'I’m best at Wolforix plans, free demo access, payouts, rules, login, checkout, and MT5 guidance. If your question is broader, I can still help briefly when I can, or point you back to the right Wolforix page.',
    ...
    'legal' => [
        ...
        'pages' => [
                ...
                'sections' => [
                    ...
                    [
                        ...
                        'bullets' => [
                            ...
                            '1-Step funded accounts must satisfy the obligatory consistency rule.',
            ...
            'company_information' => [
                ...
                'intro' => 'Wolforix Ltd. is a company incorporated in the United Kingdom, with its registered office at Suite RA01, 195-197 Wood Street, London, E17 3NU.',
                'sections' => [
                    [
                        'title' => 'Company Information',
                        'paragraphs' => [
                            'Wolforix Ltd. is a company incorporated in the United Kingdom, with its registered office at Suite RA01, 195-197 Wood Street, London, E17 3NU.',
                        ],
                    ],
                    [
                        'title' => 'Nature of Services',
    ...
    'footer' => [
        ...
        'positioning_bullets' => [
            'Fast payouts. Zero nonsense',
            'Built differently from traditional prop firms',
            'Designed for disciplined traders — not gamblers',
        ],
    ...
    'dashboard' => [
        ...
        'overview' => [
            ...
            'snapshot_copy' => 'This area now follows the MT5 challenge workspace, with live account metrics appearing as MT5 sync data becomes available.',
        ...
        'wolfi_hub_page' => [
            'title' => 'Wolfi Hub',
            'subtitle' => 'Account-aware support, platform guidance, and Wolfi context live here without crowding your trading workspace.',
            'empty_title' => 'Wolfi is getting your workspace ready',
            'empty_copy' => 'Once your dashboard context loads, Wolfi Hub will explain the current page, account status, rules, payouts, and support routes.',
        ],
        'mt5' => [
            'title' => 'MT5 live sync',
            'heading' => 'MT5 sync and account access',
            'copy' => 'Wolforix now presents the trader workflow around MT5 account data, sync freshness, and secure access details.',
        ],
        'wolfi' => [
            'entry_eyebrow' => 'Wolfi supports your',
            ...
            'welcome' => [
                ...
                'account_message' => 'I’m reading your :plan account inside :page so I can explain status, rules, payout readiness, and MT5 data in plain English.',
                'account_bullets' => [
                    'status' => 'Current status: :status with :progress profit-target progress.',
                    'balance' => 'Balance is :balance, equity is :equity, and floating P&L is :pnl.',
                    'trading_days' => 'Trading-day progress is :days for the active phase.',
                ],
                'empty_message' => 'I can explain :page, challenge rules, payouts, and support steps while Wolforix waits for an active MT5 account on this profile.',
                'empty_bullets' => [
                    'Use Wolfi Hub for the full account-aware assistant.',
                    'The main dashboard keeps the trading workspace and account data first.',
                    'Once MT5 sync data appears, Wolfi adds personalized account explanations here.',
                ],
            ],
            'stat_labels' => [
                'status' => 'Status',
            ...
            'assistant' => [
                ...
                'description' => 'Ready to support your next step with rule-aware, metric-aware guidance inside Wolfi Hub.',
                ...
                'status_idle' => 'Ready to support your next step',
                'status_thinking' => 'Wolfi is reviewing your account context',
                'status_error' => 'Wolfi hit a temporary issue. Please try again.',
                'input_placeholder' => 'Ask about your MT5 account, rules, payouts, metrics, or support...',
            ...
            'smart_insights' => [
                ...
                'description' => 'Wolfi watches your live account context and surfaces the signals that deserve attention before you even ask.',
            ],
            'pages' => [
                'dashboard' => [
                    'title' => 'Overview workspace',
                    'summary' => 'Use this page to scan the account summary, challenge progress, payout readiness, analytics, daily activity, trade details, and the direct Wolfi Hub entry point.',
                    'sections' => [
                        [
                            'title' => 'Account summary',
                            'description' => 'The hero section shows your current plan, challenge phase, MT5 sync freshness, balance, equity, and progress toward the target.',
                        ],
                        [
                            'title' => 'Command center',
                            'description' => 'Quickly check win ratio, first-trade timing, symbols traded, and the latest balance context with Wolfi centered inside the ring.',
                        ],
                        [
                            'title' => 'Wolfi access',
                            'description' => 'The compact Wolfi entry opens Wolfi Hub while the main dashboard keeps account data and trading workspace content first.',
                        ],
                    ],
                ],
                'dashboard.accounts' => [
                    'title' => 'Accounts workspace',
                    'summary' => 'Use this page to review MT5 sync health, linked challenges, billing records, and account-level challenge progress.',
                    'sections' => [
                        [
                            'title' => 'MT5 live sync',
                            'description' => 'MT5 account status explains whether account metrics are updating correctly.',
                        ],
                        [
            ...
            'insights' => [
                'risk_alert' => [
                    'label' => 'Risk Alert',
                    'daily_message' => 'Daily loss usage is getting high. Protect the account before taking another setup.',
                    'max_message' => 'Max drawdown usage is getting high. Reduce risk and protect the challenge.',
                    'meta' => 'Daily :daily% · Max :max%',
                    'prompt' => 'Explain my drawdown risk and remaining room',
                ],
                'profit_progress' => [
                    'label' => 'Profit Progress',
                    'message' => 'You are close to the current profit target. Focus on protecting gains and completing rules.',
                    'meta' => ':progress% of target',
                    'prompt' => 'Explain what remains to pass this phase',
                ],
                'consistency_warning' => [
                    'label' => 'Consistency Warning',
                    'message' => 'One trading day is carrying a large share of profit. Spread gains before requesting a payout.',
                    'meta' => 'Highest day ratio :ratio%',
                    'prompt' => 'Explain my consistency rule status',
                ],
                'payout_readiness' => [
                    'label' => 'Payout Readiness',
                    'message' => 'The payout window looks open. Confirm rule compliance and prepare the request.',
                    'meta' => 'Funded account',
        ...
        'settings' => [
            ...
            'preferences_copy' => 'The dashboard is already locale-aware, so language switching stays consistent as more supported languages are added.',
