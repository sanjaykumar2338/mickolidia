...
return [
    ...
    'checkout' => [
        ...
        'kyc_notice' => 'Client data fields are prepared for registration, purchase review, and future KYC/payout compliance.',
        'helper_points' => [
            'Validation is active for buyer name, email, street address, city, postal code, country, plan selection, and the mandatory agreement checkbox.',
