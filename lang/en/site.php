...
return [
    ...
    'auth' => [
        ...
        'login' => [
            ...
            'social_unavailable_badge' => 'Soon',
            'social_setup_notice' => 'Social sign-in UI is ready, but Google, Facebook, and Apple provider credentials and callback routes still need backend setup.',
        ],
        'register' => [
