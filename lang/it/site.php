...
return array_replace_recursive($en, [
    ...
    'auth' => [
        ...
        'passwords' => [
            ...
            'status' => [
                ...
                'mailer' => 'Non possiamo inviare l’email di reset in questo momento. Contatta il supporto o riprova più tardi.',
            ],
        ],
    ],
    'trial' => [
        ...
        'setup' => [
            'title' => 'Configura il tuo account trial',
            'description' => 'Apri il tuo account demo MT5 IC Markets, installa il connettore MT5 Wolforix e inserisci i dettagli del connettore dentro MetaTrader 5.',
            'process_label' => 'Processo trial',
            'steps' => [
                [
                    'title' => 'Passo 1: Crea il tuo account gratuito',
                    'body' => 'Registrati con email e password per iniziare la prova gratuita.',
                ],
                [
                    'title' => 'Passo 2: Apri il tuo account demo',
                    'body' => 'Apri il tuo account demo MT5 con IC Markets. Sarai reindirizzato al loro sito web.',
                ],
                [
                    'title' => 'Passo 3: Installa il connettore MT5',
                    'body' => 'Scarica il connettore MT5 Wolforix e trascina l’Expert Advisor su un grafico dentro MetaTrader 5.',
                ],
                [
                    'title' => 'Passo 4: Inserisci i dettagli del connettore',
                    'body' => 'Incolla Base URL, Account Reference e Secret Token dal dashboard negli input dell’EA. Il dashboard si aggiorna automaticamente dopo il primo sync.',
                ],
            ],
            'step_two_label' => 'Passo 2',
            'open_demo_title' => 'Apri il tuo account demo',
            'open_demo_copy' => 'Clicca il pulsante qui sotto per aprire il tuo account demo MT5 con IC Markets. Sarai reindirizzato al loro sito web.',
            'important_items' => [
                'Usa la stessa email utilizzata per registrarti.',
                'Seleziona MT5 come piattaforma.',
                'Salva i tuoi dati di accesso.',
            ],
            'open_demo_button' => 'Apri account demo',
            'step_three_label' => 'Passo 3',
            'continue_button' => 'Vai alla dashboard trial',
            'continue_success' => 'I dettagli del connettore sono pronti. Installa l’EA in MT5 e il dashboard si aggiornerà automaticamente dopo il primo sync.',
            'help_title' => 'Serve aiuto?',
            'help_copy' => 'Se hai problemi a creare il tuo account demo, contatta il nostro team di supporto a',
        ],
        'dashboard' => [
            ...
            [
                ...
                'items' => [
                    [
                        ...
                        'answer_paragraphs' => [
                            'Passo 1: Crea il tuo account gratuito Wolforix con email e password.',
                            'Passo 2: Apri il tuo account demo MT5 con IC Markets usando il pulsante nella schermata di configurazione del trial. Sarai reindirizzato a https://www.icmarkets.eu/de/open-trading-account/demo.',
                            'Importante: usa la stessa email utilizzata per registrarti su Wolforix, seleziona MT5 come piattaforma e salva i dati di accesso.',
                            'Passo 3: Scarica il connettore MT5 Wolforix dalla dashboard trial e installa l’EA in MetaTrader 5.',
                            'Passo 4: Trascina il connettore su un grafico, inserisci Base URL, Account Reference e Secret Token dal dashboard, poi clicca OK.',
                            'Passo 5: Il tuo account si connette automaticamente quando l’EA invia il primo aggiornamento.',
                            'Se hai problemi a creare il tuo account demo, contatta support@wolforix.com.',
                        ],
                    ],
                ],
            ],
    ...
    'contact' => [
        ...
        'voice_trial_fallback' => 'Registrati prima al Free Trial su Wolforix e crea il tuo conto demo MT5 IC Markets. Scarica il connettore MT5 Wolforix dalla dashboard, installa l’EA in MetaTrader 5 e inserisci Base URL, Account Reference e Secret Token nella finestra impostazioni dell’EA. La connessione avviene dentro MT5; sul sito non esiste un campo per il numero account MT5.',
