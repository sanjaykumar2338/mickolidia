...
class TradingAccountMetricsController extends Controller
{
    ...
    public function __invoke(
        ...
        try {
            $validated = Validator::make($normalizedPayload, [
                ...
                'closed_position_tickets' => ['nullable', 'array'],
                'closed_position_identifiers' => ['nullable', 'array'],
    ...
    private function payloadSummary(array $payload): array
    {
        return [
            ...
            'closed_position_tickets' => $payload['closed_position_tickets'] ?? null,
            'closed_position_identifiers' => $payload['closed_position_identifiers'] ?? null,
