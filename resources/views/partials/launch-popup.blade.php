...
<div
    ...
    class="fixed inset-0 z-[70] flex items-start justify-center overflow-y-auto px-4 py-6 sm:items-center sm:p-6"
    role="dialog"
    aria-modal="true"
...
>
    ...
    ></button>
    <div class="launch-popup-card popup-container border border-slate-500/20 shadow-[0_34px_110px_rgba(0,0,0,0.86)]">
        <button
            type="button"
            data-launch-popup-close
        ...
        <div class="popup-content flex w-full flex-col items-center gap-6">
            <div class="flex w-full flex-col items-center gap-6">
                <div class="max-w-[34rem] text-center sm:px-8">
                    <h2 id="launch-popup-title" class="launch-popup-title text-[1.85rem] font-semibold leading-tight text-white sm:text-[2.45rem]">
                        {{ __('site.launch_popup.title') }}
                    </h2>
                    <p class="launch-popup-copy mx-auto mt-4 max-w-sm text-sm leading-7 text-slate-300 sm:text-base">
                        {{ __('site.launch_popup.description') }}
                    </p>
                    <p class="launch-popup-copy mx-auto mt-3 max-w-sm text-sm leading-7 text-slate-300/90 sm:text-base">
                        {{ __('site.launch_popup.secondary_copy') }}
                    </p>
                </div>

                <div class="w-full max-w-[28rem] rounded-[1.55rem] border border-sky-200/20 bg-slate-950/60 px-4 py-4 shadow-[0_22px_60px_rgba(2,6,23,0.5)] backdrop-blur-md sm:px-5">
