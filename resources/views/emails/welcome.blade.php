                                                    ...
                                                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="margin-top:6px; border-collapse:separate; border-spacing:0;">
                                                        <tr>
                                                            ...
                                                            <td style="padding-left:8px;">
                                                                <a href="{{ route('home') }}#plans" style="display:block; padding:16px 20px; border-radius:18px; border:1px solid rgba(255,255,255,0.10); background:rgba(255,255,255,0.03); color:#f8fafc; font-size:14px; font-weight:700; text-align:center; text-decoration:none;">
                                                                    Review Challenge Plans
                                                                </a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                ...
                                <tr>
                                    <td style="padding:0 38px 36px 38px; background:rgba(6,11,20,0.92); border-top:1px solid rgba(255,255,255,0.06);">
                                        ...
                                        <p style="margin:18px 0 0 0; color:#64748b; font-size:12px; line-height:1.8; text-align:center;">
                                            This message was designed to mirror the Wolforix premium dark brand across the website, checkout, and onboarding flow.
                                        </p>
                                    </td>
                                </tr>
                            </table>
