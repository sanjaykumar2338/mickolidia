...
<section class="surface-panel overflow-hidden rounded-[2rem] p-5 sm:p-6">
    ...
    <div class="mt-6 grid gap-4 xl:grid-cols-[minmax(0,0.9fr)_minmax(0,0.9fr)_minmax(0,1.15fr)_minmax(18rem,1fr)]">
        <article class="rounded-[1.75rem] border border-amber-400/14 bg-amber-400/8 p-5 shadow-[0_22px_60px_rgba(2,6,23,0.26)]">
        ...
        <article class="rounded-[1.75rem] border border-white/8 bg-black/18 p-5">
            <div class="flex items-start justify-between gap-4">
                <div>
                    ...
                    <p class="mt-3 text-sm leading-6 text-slate-400">{{ $insights['win_rate_hint'] }}</p>
                </div>
            ...
            <div class="mt-5 flex items-center gap-5">
                <div
                    class="grid h-28 w-28 shrink-0 place-items-center rounded-full p-2"
                ...
                >
                    <div class="grid h-full w-full place-items-center rounded-full border border-white/8 bg-slate-950">
                        <span class="text-xl font-semibold text-white">{{ $insights['win_rate'] }}</span>
                    </div>
                </div>
                <div class="min-w-0">
                    <p class="text-2xl font-semibold text-white">{{ $insights['win_rate'] }}</p>
        ...
        <article id="mt5-access-panel" class="rounded-[1.75rem] border border-amber-400/16 bg-gradient-to-b from-amber-400/10 to-black/18 p-5">
            ...
            <button type="button" data-dashboard-modal-open="credentials" class="mt-5 inline-flex w-full items-center justify-center rounded-full border border-amber-300/28 bg-amber-300/14 px-4 py-3 text-sm font-semibold text-amber-50 transition hover:border-amber-200/50 hover:bg-amber-300/20">
                {{ __('Open credentials panel') }}
            </button>

            <p class="mt-4 text-xs leading-6 text-amber-50/65">{{ $mt5Access['privacy_note'] }}</p>
        </article>
    </div>
</section>
