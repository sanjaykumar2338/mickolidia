...
@section('content')
    <div class="space-y-6">
        ...
        <form
            method="POST"
            action="{{ route('dashboard.wolfi.voices.update') }}"
            class="space-y-6"
        ...
        >
                ...
                @foreach ($voiceOptions as $voice)
                    ...
                    >
                        ...
                        <div class="mt-5 flex flex-wrap items-center gap-3">
                            ...
                            >
                                {{ $ttsConfigured ? __('Play Preview') : __('Preview Unavailable') }}
                            </button>
                        </div>
                    </article>
                @endforeach
            ...
            >
                {{ $ttsConfigured ? __('Preview ready. Click Play Preview on any voice card.') : __('OpenAI TTS is not configured, so previews are currently unavailable.') }}
            </div>
