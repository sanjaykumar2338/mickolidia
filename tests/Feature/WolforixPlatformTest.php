...
class WolforixPlatformTest extends TestCase
{
    ...
    public function test_mt5_setup_route_loads_generic_connector_setup_for_authenticated_mt5_users(): void
    {
        ...
        $this->actingAs($user)
            ...
            ->assertSee('MT5 Desktop Required')
            ->assertSee('This setup must be completed from a Windows or Mac computer using MetaTrader 5 Desktop.')
            ->assertSee('Setup time: approximately 5–10 minutes. No coding required.')
    ...
    public function test_authenticated_user_can_download_preconfigured_mt5_connector_for_own_account(): void
    {
        ...
        $syncInclude = (string) $zip->getFromName('Include/WolforixSync.mqh');
        ...
        $this->assertSame(url('/'), $config['base_url']);
        ...
        $this->assertStringContainsString('ApiBaseUrl              = "'.url('/').'"', $eaSource);
        ...
        $this->assertStringContainsString('Tools > Options > Expert Advisors', $readme);
