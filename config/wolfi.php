...
return [
    ...
    'voices' => [
        'provider' => 'web_speech',
        'default' => env('WOLFI_TTS_VOICE', 'webspeech-en-guide'),
        ...
        'options' => [
            ...
            [
                ...
                'provider_voice_id' => env('WOLFI_ELEVENLABS_VOICE_ID', 'pNInz6obpgDQGcFmaJgB'),
                'locale_voice_ids' => [
                    'en' => env('WOLFI_ELEVENLABS_VOICE_ID_EN', env('WOLFI_ELEVENLABS_VOICE_ID', 'pNInz6obpgDQGcFmaJgB')),
                    'de' => env('WOLFI_ELEVENLABS_VOICE_ID_DE', env('WOLFI_ELEVENLABS_VOICE_ID', 'pNInz6obpgDQGcFmaJgB')),
                    'es' => env('WOLFI_ELEVENLABS_VOICE_ID_ES', env('WOLFI_ELEVENLABS_VOICE_ID', 'pNInz6obpgDQGcFmaJgB')),
                    'fr' => env('WOLFI_ELEVENLABS_VOICE_ID_FR', env('WOLFI_ELEVENLABS_VOICE_ID', 'pNInz6obpgDQGcFmaJgB')),
                    'hi' => env('WOLFI_ELEVENLABS_VOICE_ID_HI', env('WOLFI_ELEVENLABS_VOICE_ID', 'pNInz6obpgDQGcFmaJgB')),
                    'it' => env('WOLFI_ELEVENLABS_VOICE_ID_IT', env('WOLFI_ELEVENLABS_VOICE_ID', 'pNInz6obpgDQGcFmaJgB')),
                    'pt' => env('WOLFI_ELEVENLABS_VOICE_ID_PT', env('WOLFI_ELEVENLABS_VOICE_ID', 'pNInz6obpgDQGcFmaJgB')),
                ],
